...
class AppRouter {
  static final router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: '/details', name: 'details', builder: (context, state) => const ProductDetailsPage()),
      ...
      GoRoute(path: '/ordering', name: 'ordering', builder: (context, state) => const TableOrderingPage()),
      GoRoute(path: '/task-detail', name: 'task-detail', builder: (context, state) => const TaskDetailPage()),
