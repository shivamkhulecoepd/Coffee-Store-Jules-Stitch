    ...
    return GestureDetector(
      ...
      child: AppGlassContainer(
        ...
        child: ListTile(
          ...
          subtitle: Text(subtitle, style: AppTypography.bodyMedium.copyWith(color: AppColors.outline, fontSize: 12.sp)),
          trailing: Icon(Icons.arrow_forward_ios, color: AppColors.outline, size: 16.sp),
        ),
      ),
    );
  }
